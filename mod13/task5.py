...
def generate_test_data(cursor, number_of_groups):
    ...
    adjectives = ['BLACK', 'RED', 'GREEN', 'YELLOW', 'BLUE', 'MAGENTA', 'CYAN', 'WHITE']
    nouns = ["dog", "cat", "elephant", "giraffe", "lion", "tiger", "zebra", "monkey"]
    ...
    while len(name_teams) < number_of_groups * 4:
        generate_name = random.choice(adjectives) + " " + random.choice(nouns)
